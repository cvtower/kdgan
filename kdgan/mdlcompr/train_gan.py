...
tf.app.flags.DEFINE_float('dis_learning_rate_decay_factor', 0.90, '')
tf.app.flags.DEFINE_float('dis_num_epochs_per_decay', 40.0, '')
tf.app.flags.DEFINE_float('gen_learning_rate', 1e-3, '')
tf.app.flags.DEFINE_float('gen_learning_rate_decay_factor', 0.94, '')
tf.app.flags.DEFINE_float('gen_num_epochs_per_decay', 20.0, '')
