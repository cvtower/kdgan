...
tf.app.flags.DEFINE_float('tch_weight_decay', 0e-5, 'l2 coefficient')
...
tf.app.flags.DEFINE_float('dis_learning_rate', 1e-1, '')
tf.app.flags.DEFINE_float('gen_learning_rate', 1e-1, '')
tf.app.flags.DEFINE_float('tch_learning_rate', 1e-1, '')
